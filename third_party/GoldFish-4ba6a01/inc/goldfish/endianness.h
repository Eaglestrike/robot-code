...
#if __BYTE_ORDER__ == __ORDER_BIG_ENDIAN__ || __BYTE_ORDER == __BIG_ENDIAN || _BYTE_ORDER == _BIG_ENDIAN || BYTE_ORDER == BIG_ENDIAN ||    \
    defined(_BIG_ENDIAN) || defined(__ARMEB__) || defined(__THUMBEB__) || defined(__AARCH64EB__) || defined(_MIBSEB) ||                    \
    defined(__MIBSEB) || defined(__MIBSEB__) || defined(_M_PPC)
#define __BIG_ENDIAN__
#elif __BYTE_ORDER__ == __ORDER_LITTLE_ENDIAN__ || /* gcc */                                                                               \
    __BYTE_ORDER == __LITTLE_ENDIAN /* linux header */ || _BYTE_ORDER == _LITTLE_ENDIAN ||                                                 \
    BYTE_ORDER == LITTLE_ENDIAN /* mingw header */ || defined(_LITTLE_ENDIAN) || /* solaris */                                             \

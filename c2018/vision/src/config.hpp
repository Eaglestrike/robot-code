...
const std::string CAM_FORWARD_ID("/dev/v4l/by-path/platform-70090000.xusb-usb-0:3:1.0-video-index0");
const std::string CAM_REVERSE_ID("/dev/v4l/by-path/platform-70090000.xusb-usb-0:4:1.0-video-index0");

...
const RobotConfig MakeDefaultRobotConfig() {
    ...
    // TODO the rest
    c.intake.rot_talon_id = 41; //needs to be updated?
    ...
    c.shooter.master_id = 5; //left side of shooter
    c.shooter.slave_id = 6; //right side of shooter
    c.shooter.turret_id = 4;
    ...
    c.shooter.kicker_cmd = 0.7; //IIF YOU CHANGE THIS U GOTTA REDO AUTO SHOOT DATA
